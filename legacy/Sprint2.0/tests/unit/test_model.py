from my_app.models import User, Task, Project, Sprint
...
def test_new_project():
    ...
    assert project.creation == datetime.strptime('06/06/1999', '%d/%m/%Y').date()
...
def test_sprint():
    ...
    assert sprint.creation == datetime.strptime('06/06/1999', '%d/%m/%Y').date()
...
def test_new_task():
    ...
    task = Task(name = "testTask", 
                ...
                creation = datetime.strptime('06/06/2023', '%d/%m/%Y').date(),
                status = 0,
                pokerScore = 1,
                sprint_id = 1)
    ...
    assert task.creation == datetime.strptime('06/06/2023', '%d/%m/%Y').date()
