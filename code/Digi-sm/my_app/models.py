...
"""
Description:
    This is a table which serves to store the friend requests temporarily until the user accepts or declines the request.
"""
...
"""
Description:
    This is a table which serves to store the friendlist of a user. Its only one way but the logic of the server takes care of it.
    This means that if user A is friends with user B then user B is also friends with user A.
"""
